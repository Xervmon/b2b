...
{	
	...
	protected function _migrateTables()
	{
		...
		$query->truncate('#__payplans_invoice')->dbLoadQuery()->query();
		$query->truncate('#__payplans_transaction')->dbLoadQuery()->query();
		$query->truncate('#__payplans_modifier')->dbLoadQuery()->query();
		$query->truncate('#__payplans_resource')->dbLoadQuery()->query();
		$query->truncate('#__payplans_statistics')->dbLoadQuery()->query();
		$query->truncate('#__payplans_log')->dbLoadQuery()->query();
		$query->clear();
