	...
	<?php foreach($subscriptions as $subscription): ?>
		...
		<div class="row-fluid" style="margin-top: 7px;">
		 ...
		 <div class="offset1 span7">
			...
			<div class="span4" >
				<a href="#" id="payplans-upgrade-continue-<?php echo $subscription->getKey();?>" onClick="payplans.apps.upgrade.getPlansUpgradeTo('<?php echo $subscription->getKey();?>'); return false;" class="btn btn-primary" ><?php echo XiText::_('PLG_PAYPLANS_UPGRADE_THIS_SUBSCRIPTION'); ?></a>
