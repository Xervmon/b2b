...
<ul class="nav nav-tabs">
  <li id="sales-details" class='active'><a href="#charts-details-sales" data-toggle="tab"><?php echo XiText::_('COM_PAYPLANS_STATISTICS_DETAILS_CHART_RECENT_SALES'); ?></a></li>
  <li id="error-details"><a href="#charts-details-errors" data-toggle="tab" id="charts-details-error"><?php echo XiText::_('COM_PAYPLANS_ERROR_LOG'); ?></a></li>
  <li id="txns-details"><a href="#charts-details-txns" data-toggle="tab" id="charts-details-txn"><?php  echo XiText::_('COM_PAYPLANS_STATISTICS_DETAILS_CHART_RECENT_TRANSACTIONS');?></a></li>
  <li id="gateway-details"><a href="#charts-details-gateways" data-toggle="tab" id="charts-details-gateway"><?php echo XiText::_('COM_PAYPLANS_STATISTICS_DETAILS_CHART_PAYMENT_GATEWAY_INFO');?></a></li>
</ul>
...
<div class="tab-content">
	...
	<!-- Payment Gateway Details-->  
  	...
  	<?php if(!$gatewayInfo):?>
		<p class="lead well well-large">
 			<?php echo XiText::_('COM_PAYPLANS_STATISTICS_DETAILS_CHART_RECENT_PAYMENT_GATEWAY_INFO_EMPTY'); ?>
		</p>
	<?php else:?> 
		<?php $count = 1;?>
		<table class='table table-hover table-bordered'>
