...
<div class="pp-invoice-details">
	<fieldset class="form-horizontal">
		...
		<div class="pull-right">
				<a href="<?php echo XiRoute::_('index.php?option=com_payplans&view=order&task=createInvoice&id='.$order->getId(), false);?>" onclick="this.onclick=function(){return false;}" class="btn btn-info"><i class="icon-plus icon-white"></i>
				<strong><?php echo ' '.XiText::_('COM_PAYPLANS_ORDER_EDIT_INVOICE_ADD_INVOICE');?></strong></a>
                </div>
