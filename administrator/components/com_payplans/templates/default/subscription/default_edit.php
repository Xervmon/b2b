	...
	<div class="span6">			   
		<fieldset class="form-horizontal">
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo PayplansHtml::_('status.edit', 'Payplans_form[status]', $subscription->getStatus(), 'SUBSCRIPTION'); ?>
					<span onclick="payplans.url.modal('<?php echo 'index.php?option=com_payplans&view=subscription&task=statusHelp';?>'); return false;" class="pp-invoice-status pp-float-left theme-preview-link">&nbsp;&nbsp;&nbsp;&nbsp;</span>	
				</div>			
			</div>
