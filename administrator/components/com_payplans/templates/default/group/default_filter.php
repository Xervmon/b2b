...
<div class="container-fluid well">
	<div class="row-fluid">
		...
		<div class="span9">
			...
			<div class="span3 hidden-phone" style="min-width: 100px;">
			<?php $attr['none'] = XiText::_('COM_PAYPLANS_GROUP_SELECT_PARENT');?>
				<?php echo PayplansHtml::_('groups.filter', 'parent', 'group', $filters, $attr);?>
			</div>
