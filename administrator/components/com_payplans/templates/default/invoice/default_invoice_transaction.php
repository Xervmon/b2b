	...
	<fieldset class="form-horizontal">
		...
		<?php if ($invoice->getId()):?>
			<div class="pull-right">
				<a href="<?php echo XiRoute::_('index.php?option=com_payplans&view=invoice&task=addTransaction&invoice_id='.$invoice->getId());?>" onclick="this.onclick=function(){return false;}" class="btn btn-info"><i class="icon-plus icon-white"></i><strong><?php echo ' '.XiText::_('COM_PAYPLANS_INVOICE_EDIT_ADD_TRANSACTION');?></strong></a>
			</div>
		<?php endif;?>
