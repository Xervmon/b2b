		...
		<div class="span6">	
		   ...
		   <!-- ================== Detail section ====================== -->
			...
			<fieldset class="form-horizontal">
				...
				<div class="control-group">
					<div class="control-label hasTip" title="<?php echo XiText::_('COM_PAYPLANS_INVOICE_GRID_TOOLTIP_INVOICE_SERIAL') ?>" >
			 		<?php echo XiText::_('COM_PAYPLANS_INVOICE_GRID_INVOICE_SERIAL') ?> 
			 		</div>
					<div class="controls"><?php echo $invoice->getSerial(); ?>
					</div>
				</div>
				...
				<div class="control-group">
					...
					$refObject = $invoice->getReferenceObject(PAYPLANS_INSTANCE_REQUIRE); 
					if ($refObject instanceof XiLib):
						echo $refObject->getObjectLink();
					else :
						echo $refObject;  ?>
						<?php endif;?>
					</div>
				...
				<div class="control-group">
					<div class="control-label hasTip" title="<?php echo XiText::_('COM_PAYPLANS_INVOICE_EDIT_TOOLTIP_TAXABLE') ?>" >
				 		<?php echo XiText::_('COM_PAYPLANS_INVOICE_EDIT_TAXABLE') ?> 
				 	</div>
				 	<?php $amount = $invoice->getTaxableAmount();?>
				...
				<div class="control-group">
					...
					<div class="controls"><?php echo PayplansHtml::_('status.edit', 'status', $invoice->getStatus(), 'INVOICE');?>
						<span onclick="payplans.url.modal('<?php echo 'index.php?option=com_payplans&view=invoice&task=statusHelp';?>'); return false;" class="pp-invoice-status pp-float-left theme-preview-link">&nbsp;&nbsp;&nbsp;&nbsp;</span>		
				...
				<div class="control-group">
					<div class="control-label hasTip" title="<?php echo XiText::_('COM_PAYPLANS_INVOICE_GRID_PAID_DATE') ?>" >
				 		<?php echo XiText::_('COM_PAYPLANS_INVOICE_GRID_PAID_DATE') ?> 
				 	</div>
					<div class="controls"><?php echo XiDate::timeago($invoice->getPaidDate()->toMySql()); ?>
					</div>
				</div>
