		...
		<div class="span9">
			...
			<div class="span11">
				...
				<div class="span2 hidden-phone" style="min-width: 170px;">
					<label><?php echo XiText::_('COM_PAYPLANS_INVOICE_GRID_PAID_DATE');?></label>
					<div>
						<?php $attr['style'] = "width:89px;"; ?>
						<?php echo PayplansHtml::_('range.filter', 'paid_date', 'invoice', $filters, 'date', 'filter_payplans', $attr);?>
					</div>
				</div>
