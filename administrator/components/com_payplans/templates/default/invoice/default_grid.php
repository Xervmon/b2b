	...
	<table class="table table-striped">
		...
		<!-- TABLE HEADER START -->
			<tr>
				...
				<th><?php echo PayplansHtml::_('grid.sort', "COM_PAYPLANS_INVOICE_GRID_INVOICE_SERIAL", 'serial', $filter_order_Dir, $filter_order);?></th>
				...
				<th class="hidden-phone"><?php echo PayplansHtml::_('grid.sort', "COM_PAYPLANS_INVOICE_GRID_PAID_DATE", 'paid_date', $filter_order_Dir, $filter_order);?></th>
		...
		<!-- TABLE BODY START -->
			...
			foreach ($records as $record):?>
				<tr class="<?php echo "row".$count%2; ?>">
    				...
    				<td><?php echo (null == $record->serial)?XiText::_('COM_PAYPLANS_NOT_APPLICABLE'):$record->serial; ?></td>
					...
					<?php $statusBadgeClass = array(PayplansStatus::NONE => '',
													PayplansStatus::INVOICE_CONFIRMED => 'label-warning',
													PayplansStatus::INVOICE_PAID => 'label-success',
													PayplansStatus::INVOICE_REFUNDED => 'label-important',
											 		PayplansStatus::INVOICE_WALLET_RECHARGE => 'label-info');?>

					<td><?php $status = PayplansStatus::getStatusOf('INVOICE');?>
						<span class="label <?php echo $statusBadgeClass[$record->status];?>"><?php echo XiText::_('COM_PAYPLANS_STATUS_'.$status[$record->status]);?></span>
					</td>
					
					<td class="hidden-phone"><?php echo XiDate::timeago($record->paid_date); ?></td>
