...
<div id="auto-register">
	<fieldset class="form-vertical">
		...
		<div class="control-group">
			<div class="offset8">
				<button type="submit" class="btn" id="payplansRegisterAuto" name="payplansRegisterAuto" onclick="this.onclick=function(){return false;}"><i class="icon-user"></i>&nbsp;<?php echo XiText::_('COM_PAYPLANS_PLAN_REGISTER_AUTO')?></button>
			</div>
		</div>
	</fieldset>
</div>
