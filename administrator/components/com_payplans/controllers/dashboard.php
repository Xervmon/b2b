...
class PayplansadminControllerDashboard extends XiController
{
	...
	public function modsearch($searchText=null,$referenceObj='all',$matchCriteria='any')
	{
		// do search
		$input 			= JFactory::getApplication()->input;
		$searchText 	= $input->get('searchText', $searchText);
		$referenceObj 	= $input->get('referenceObj', $referenceObj);
		$matchCriteria  = $input->get('matchCriteria', $matchCriteria);
 	
		$results = PayplansHelperSearch::doSearch($searchText,$referenceObj,$matchCriteria);
