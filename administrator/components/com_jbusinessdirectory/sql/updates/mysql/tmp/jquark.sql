...
--
-- Table structure for table `#__jbusinessdirectory_category_options`
--

CREATE TABLE IF NOT EXISTS `#__jbusinessdirectory_category_options` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(55) DEFAULT NULL,
  `category_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_NAME` (`category_id`,`name`)
...
CREATE TABLE IF NOT EXISTS `#__jbusinessdirectory_companies` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `alias` varchar(245) DEFAULT NULL,
  ...
  `h1` varchar(85) DEFAULT NULL,
  `h2` varchar(85) DEFAULT NULL,
  `h3` varchar(85) DEFAULT NULL,
  `h4` varchar(85) DEFAULT NULL,
  `h5` varchar(85) DEFAULT NULL,
  `insurance` varchar(245) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__jbusinessdirectory_company_offers` (
  ...
  `alias` varchar(145) NOT NULL DEFAULT '',
  `short_description` varchar(255) DEFAULT NULL,
  `description` text,
...
--
-- Table structure for table `#__jbusinessdirectory_states`
--

CREATE TABLE IF NOT EXISTS `#__jbusinessdirectory_states` (
...
--
-- Table structure for table `#__jbusinessdirectory_state_cities`
--

CREATE TABLE IF NOT EXISTS `#__jbusinessdirectory_state_cities` (
