	...
	<table class="table table-striped adminlist"  id="itemList">
		<thead>
			<tr>
				...
				<th><?php echo JHtml::_('grid.sort', 'LNG_LAST_MODIFIED', 'bc.email', $listDirn, $listOrder); ?></th>
				<th><?php echo JHtml::_('grid.sort', 'LNG_CITY', 'bc.address', $listDirn, $listOrder); ?></th>
				<?php if($this->appsettings->enable_packages){?>
					<th><?php echo JHtml::_('grid.sort', 'LNG_PACKAGE', 'ct.name', $listDirn, $listOrder); ?></th>
					<th><?php echo JHtml::_('grid.sort', 'LNG_PACKAGE_STATUS', 'ct.name', $listDirn, $listOrder); ?></th>
				<?php } ?>
				<th width="5%"><?php echo JHtml::_('grid.sort', 'LNG_VIEW_NUMBER', 'bc.viewCount', $listDirn, $listOrder); ?></th>
				<th width="5%"><?php echo JHtml::_('grid.sort', 'LNG_WEBSITE_CLICKS', 'bc.websiteCount', $listDirn, $listOrder); ?></th>
				<th width="5%"><?php echo JHtml::_('grid.sort', 'LNG_CONTACT_NUMBER', 'bc.contactCount', $listDirn, $listOrder); ?></th>
				<th><?php echo JHtml::_('grid.sort', 'LNG_STATE', 'bc.state', $listDirn, $listOrder); ?></th>
				<th><?php echo JHtml::_('grid.sort', 'LNG_FEATURED', 'bc.featured', $listDirn, $listOrder); ?></th>
				<th><?php echo JHtml::_('grid.sort', 'LNG_APROVED', 'bc.approved', $listDirn, $listOrder); ?></th>
				<th nowrap width="1%"><?php echo JHtml::_('grid.sort', 'LNG_ID', 'bc.id', $listDirn, $listOrder); ?></th>
			</tr>
		</thead>
		<tfoot>
				<tr>
