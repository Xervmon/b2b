...
<form action="<?php echo JRoute::_('index.php?option=com_jbusinessdirectory&tmpl=component&layout=locations'); ?>" method="post" name="adminForm" id="item-form" class="form-horizontal">
		...
		<div class="form-box">
			...
			<div class="detail_box">
				...
				<select class="input_sel <?php echo $attributeConfig["country"] == ATTRIBUTE_MANDATORY?"validate[required]":""?> select" name="countryId" id="country" >
						...
						?>
							<option <?php echo $this->location->countryId==$country->country_id? "selected" : ""?> 
			...
			<div class="detail_box">
				...
				<input class="input_txt <?php echo $attributeConfig["city"] == ATTRIBUTE_MANDATORY?"validate[required]":""?> text-input" type="text" name="city" id="locality" value="<?php echo $this->location->city ?>">
				<div class="clear"></div>
			...
			<div class="detail_box" id="districtContainer">
				...
				<input class="input_txt <?php echo $attributeConfig["region"] == ATTRIBUTE_MANDATORY?"validate[required]":""?> text-input" name="county" id="administrative_area_level_1" value="<?php echo $this->location->county ?>" />
				<div class="clear"></div>
			...
			<div class="detail_box" id="districtContainer">
				...
				<input class="input_sel <?php echo $attributeConfig["postal_code"] == ATTRIBUTE_MANDATORY?"validate[required]":""?>" name="postalCode" id="postal_code" value="<?php echo $this->location->postalCode ?>" />
				<div class="clear"></div>
			</div>
			<?php } ?>
	...
	<input type="hidden" name="company_id" value="<?php echo $this->item->id ?>" /> 
	<input type="hidden" name="locationId" id="locationId" value="<?php echo $this->location->id ?>" />
