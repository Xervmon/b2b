	...
	<table class="table table-striped adminlist"  id="itemList">
		<thead>
			<tr>
				...
				<th width='10%' ><?php echo JHtml::_('grid.sort', 'LNG_PUBLISH_START_DATE', 'co.price', $listDirn, $listOrder); ?></th>
				<th width='10%' ><?php echo JHtml::_('grid.sort', 'LNG_PUBLISH_END_DATE', 'co.publish_start_date', $listDirn, $listOrder); ?></th>
				<th width='10%' ><?php echo JHtml::_('grid.sort', 'LNG_START_DATE', 'co.publish_end_date', $listDirn, $listOrder); ?></th>
