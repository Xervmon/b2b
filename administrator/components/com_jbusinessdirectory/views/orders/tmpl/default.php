	...
	<table class="table table-striped adminlist"  id="itemList">
		<thead>
			<tr>
				...
				<th width='23%' ><?php echo JHtml::_('grid.sort', 'LNG_COMPANY', 'c.name', $listDirn, $listOrder); ?></th>
				<th width='23%' ><?php echo JHtml::_('grid.sort', 'LNG_PACKAGE', 'p.name', $listDirn, $listOrder); ?></th>
				<th width='10%' ><?php echo JHtml::_('grid.sort', 'LNG_AMOUNT', 'inv.amount', $listDirn, $listOrder); ?></th>
				<th width='10%' ><?php echo JHtml::_('grid.sort', 'LNG_CREATED', 'inv.created', $listDirn, $listOrder); ?></th>
				<th nowrap="nowrap" width='10%' ><?php echo JHtml::_('grid.sort', 'LNG_START_DATE', 'inv.paid_at', $listDirn, $listOrder); ?></th>
				<th width='10%' ><?php echo JHtml::_('grid.sort', 'LNG_USER', 'inv.user_name', $listDirn, $listOrder); ?></th>
				<th width='10%' ><?php echo JHtml::_('grid.sort', 'LNG_STATE', 'inv.state', $listDirn, $listOrder); ?></th>
				<th nowrap="nowrap" width='1%' ><?php echo JHtml::_('grid.sort', 'LNG_ID', 'inv.id', $listDirn, $listOrder); ?></th>
				<th></th>
			</tr>
		</thead>
		<tfoot>
		...
		<tbody>
			...
			>
				...
				<TD align=center>
					...
					<td>	
						<a href="javascript:showInvoice(<?php echo  $item->id ?>)"><?php echo JText::_("LNG_INVOICE") ?></a>
					</td>
				</TR>
			<?php
				$i++;
...
<div id="invoice" class="invoice" style="display:none">
	<div id="dialog-container">
		...
		<div class="dialogContent" style="padding:10px;">
			<iframe id="invoiceIfr" height="400" src="" scrolling="no">
...
function showInvoice(invoice){
	...
	jQuery.blockUI({ message: jQuery('#invoice'), css: {width: '800px', top: '10%', position: 'absolute', left: (jQuery(window).width() - 800) /2 + 'px'} });
