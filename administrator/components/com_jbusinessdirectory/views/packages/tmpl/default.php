...
//$saveOrderingUrl = 'index.php?option=com_jbusinessdirectory&task=packages.saveOrderAjax&tmpl=component';
	...
	<table class="table table-striped adminlist"  id="itemList">
		<thead>
			<tr>
				...
				<th nowrap="nowrap" width='23%' ><?php echo JText::_('LNG_DESCRIPTION')?></th>
				...
				<TR class="row<?php echo $i % 2; ?>"
					...
					<td valign=top align=center>
							<img  
								...
								onclick	=	"	
												document.location.href = '<?php echo JRoute::_( 'index.php?option=com_jbusinessdirectory&task=packages.chageState&id='. $item->id )?> '
											"
							/>
					</td>
