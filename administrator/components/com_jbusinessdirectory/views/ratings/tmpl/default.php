...
<script type="text/javascript">
	...
	{
		if (task != 'ratings.delete' || confirm('<?php echo JText::_('COM_JBUSINESSDIRECTORY_REVIEW_CONFIRM_DELETE', true);?>'))
		{
	...
	<table class="table table-striped adminlist"  id="itemList">
		<thead>
			<tr>
				...
				<th><?php echo JHtml::_('grid.sort', 'LNG_SUBJECT', 'cr.subject', $listDirn, $listOrder); ?></th>
				<th><?php echo JText::_('LNG_DESCRIPTION'); ?></th>
				<th><?php echo JHtml::_('grid.sort', 'LNG_RATING', 'cr.rating', $listDirn, $listOrder); ?></th>
				<th><?php echo JHtml::_('grid.sort', 'LNG_USER', 'u.username', $listDirn, $listOrder); ?></th>
				<th width="5%" class="nowrap"><?php echo JHtml::_('grid.sort', 'LNG_LIKE_COUNT', 'cr.likeCount', $listDirn, $listOrder); ?></th>
				<th width="5%" class="nowrap"><?php echo JHtml::_('grid.sort', 'LNG_DISLIKE_COUNT', 'cr.dislikeCount', $listDirn, $listOrder); ?></th>
				<th><?php echo JHtml::_('grid.sort', 'LNG_COMPANY', 'companyName', $listDirn, $listOrder); ?></th>
				<th><?php echo JHtml::_('grid.sort', 'LNG_CREATION_DATE', 'cr.creationDate', $listDirn, $listOrder); ?></th>
				<th><?php echo JHtml::_('grid.sort', 'LNG_STATE', 'cr.state', $listDirn, $listOrder); ?></th>
				<th><?php echo JHtml::_('grid.sort', 'LNG_ID', 'cr.id', $listDirn, $listOrder); ?></th>
			</tr>
		</thead>
		<tfoot>
				<tr>
		...
		<tbody>
			...
			>
				...
				<TD align=left>
					...
					<a href='<?php echo JRoute::_( 'index.php?option=com_jbusinessdirectory&task=rating.edit&id='. $review->id )?>'
				...
				<td valign=top align=center>
							<img  
								...
								onclick	=	"	
												document.location.href = '<?php echo JRoute::_( 'index.php?option=com_jbusinessdirectory&task=ratings.chageState&id='. $review->id )?> '
											"
							/>
				</td>
				<td>
