...
class JBusinessDirectoryHelper
{
	...
	public static function addSubmenu($vName)
	{
		...
		JSubMenuHelper::addEntry(
			...
			'index.php?option=com_jbusinessdirectory&view=managecategories',
			$vName == 'categories'
		);
	...
	public static function getPackageFeatures(){
		$feaures = array(HTML_DESCRIPTION=>JText::_("LNG_HTML_DESCRIPTION"),
	...
	public static function getPackageOptions(){
		...
		$db = JFactory::getDbo();
		$query = "select * from #__jbusinessdirectory_packages p where p.status =1 order by ordering asc";
		// 		dump($query);
		$db->setQuery($query);
