...
class JFormFieldFactoryRules extends JFormFieldRules
{
  ...
  protected function getInput()
    ...
    $component = '' == $component ? JFactory::getApplication()->input->getCmd('option') : '';
    ...
    $actions = array();
        ...
        if ('' == $temp['title']) {
          $temp['title'] = FactoryText::_('rules_' . str_replace('.', '_', $temp['name']) . '_label');
        }

        if ('' == $temp['description']) {
          $temp['description'] = FactoryText::_('rules_' . str_replace('.', '_', $temp['name']) . '_desc');
        }
