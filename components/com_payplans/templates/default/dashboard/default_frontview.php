...
<?php  if(empty($subscription_records)):?>
	<div class="well well-large">
		<div class="page-header">
		    <h1 class="text-center"><small><?php echo XiText::_('COM_PAYPLANS_DASHBOARD_ORDER_WIDGET_NO_SUBSCRIPTIONS');?></small></h1>
		    <p class="text-center pp-gap-top20"><a href="<?php echo XiRoute::_('index.php?option=com_payplans&view=plan&task=subscribe'); ?>" class="btn btn-large btn-info">
