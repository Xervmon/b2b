...
class PayplanssiteControllerUser extends XiController
{
	...
	{		
		...
		if(!$user->login($args['username'], $args['password'])){
			$response->addScriptCall('payplans.jQuery("span.err-payplansLoginError").html', "<div class='row-fluid'>".XiText::_('COM_PAYPLANS_LOGIN_FAILED')."</div>");
