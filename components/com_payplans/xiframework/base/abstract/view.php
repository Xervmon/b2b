...
abstract class XiAbstractViewBase extends XiAbstractViewBaseAdapt
{
	...
	protected function _showAdminFooter()
	{
        ...
        <div class="powered-by">
	       <?php echo XiText::_('COM_PAYPLANS_POWERED_BY') .'<a id="payplans-powered-by" href="http://www.readybytes.net/payplans.html" target="_blank" >PayPlans</a><sup>TM</sup>';?>
		   <?php echo ' | '.XiText::_('COM_PAYPLANS_FOOTER_VERSION').' <strong>'.PAYPLANS_VERSION .'</strong> | '. XiText::_('COM_PAYPLANS_FOOTER_BUILD').PAYPLANS_REVISION; ?>	  	
        	<?php echo '<br />'
        		...
        		.'<a href="http://bit.ly/lrECHY" target="_blank" >'.XiText::_('COM_PAYPLANS_FOOTER_MESSAGE_LINK').'</a>'
...
// Include the Joomla Version Specific class, which will ad XiAbstractView class automatically
XiError::assert(class_exists('XiAbstractJ'.PAYPLANS_JVERSION_FAMILY.'View',true), XiError::ERROR);
