...
//		$row->parent_id		= 1; // gives segmentation fault
	...
	public static function getExtension($element, $name = null, $published = null, $extensionType = 'component'){
		...
		$component[$element] = $query->dbLoadQuery()
				   	 			->loadObjectList();			
