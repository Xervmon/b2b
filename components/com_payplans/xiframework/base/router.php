...
if(!class_exists('XiBaseRouter')) {
	if(class_exists('JComponentRouterBase')) {
		abstract class XiBaseRouter extends JComponentRouterBase {}
	} else {
		class XiBaseRouter {}
	}
}

abstract class XiRouter extends XiBaseRouter
{
    ...
    {
        if($this->_menus ===null){
        	$site = XiFactory::getApplication('site');
