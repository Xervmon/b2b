...
class PayplansHelperLogger
{
	...
	public static function dumpDataInFile($log_id,$finalContent,$random = '')
	{
	...
	public static function calculateFileName($log_id,$random = '')
	{
			//32 MB in bytes.
			$maxFolderSize = 32768;
			$folder_id = 1;
	 ...
	 */
	public static function calculateLogData($log_position, $token)
	{
