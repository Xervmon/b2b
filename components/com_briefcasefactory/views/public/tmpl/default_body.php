...
if ($this->parent->parent_id): ?>
  <tr>
    ...
    <td colspan="10">
      <a href="<?php echo FactoryRoute::view($this->getName() . '&parent=' . $this->parentId . '&' . $this->filters); ?>">
  ...
  <tr data-url-edit="<?php echo FactoryRoute::task($this->item->type . '.edit&id=' . $this->item->id); ?>">
    ...
    <td>
      <?php if ('folder' == $this->item->type): ?>
        <a href="<?php echo FactoryRoute::view($this->getName() . '&parent=' . $this->item->id . '&' . $this->filters); ?>"
      <?php else: ?>
