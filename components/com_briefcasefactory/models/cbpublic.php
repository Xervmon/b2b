...
class BriefcaseFactoryFrontendModelCbPublic extends JModelLegacy
{
  ...
  public function getItems()
  {
    $results = $this->profile_user_id == $this->visitor_user_id
             ? $this->getMyPublicItems()
             : $this->getUserPublicItems();
  ...
  {
    /* @var $model BriefcaseFactoryFrontendModelPublic */
    $model = JModelLegacy::getInstance('Public', 'BriefcaseFactoryFrontendModel');
  ...
  protected function getMyPublicItems()
  {
    // Initialise variables.
    $dbo    = $this->getDbo();
  ...
  protected function getUserPublicItems()
  {
    // Initialise variables.
    $dbo    = $this->getDbo();
    $parent = $this->getParent();
  ...
  protected function getUserQueryForFiles($folder_id, $total = false)
  {
    ...
    $query->where('f.user_id = ' . $query->q($this->profile_user_id));
