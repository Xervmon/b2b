...
class BriefcaseFactoryFrontendModelSharePublic extends FactoryModelAdmin
{
  public function getForm($data = array(), $loadData = true)
  {
    ...
    $form = JForm::getInstance('com_briefcasefactory.sharepublic', 'sharepublic', array('control' => 'jform'));
