    ...
    public function addLike($element, $itemId) {
        ...
        switch ($element) {
            ...
            case 'photo':
                ...
                $photo->load($itemId);
                if ($photo->id) {
                    $url = CRoute::_($photo->getRawPhotoURI());
                    $params = new CParameter('');
                    $params->set('url', $url);
            ...
            case 'album':
                ...
                if ($album->id) {
                    if ($album->groupid) {
                        $url = CRoute::_('index.php?option=com_community&view=photos&task=album&albumid=' . $album->id . '&groupid=' . $album->groupid);
                    } else {
                        $url = CRoute::_('index.php?option=com_community&view=photos&task=album&albumid=' . $album->id);
                    }
            ...
            case 'videos':
                ...
                if ($video->id) {
                    if ($video->groupid) {
                        $url = CRoute::_('index.php?option=com_community&view=videos&task=video&groupid=' . $video->groupid . '&videoid=' . $video->id);
                    } else {
                        $url = CRoute::_('index.php?option=com_community&view=videos&task=video&videoid=' . $video->id);
                    }
                    $params = new CParameter('');
                    $params->set('url', $url);
            ...
            case 'profile':
                ...
                if ($profile->id) {
                    $url = CRoute::_('index.php?option=com_community&view=profile&userid=' . $profile->id);
                    $params = new CParameter('');
                    $params->set('url', $url);
            ...
            case 'profile.status':
                ...
                if ($stream->id) {
                    ...
                    $url = CRoute::_('index.php?option=com_community&view=profile&userid=' . $profile->id . '&actid=' . $stream->id);
                    $params = new CParameter('');
                    $params->set('url', $url);
