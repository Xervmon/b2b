...
<!-- layout -->
<div id="layout" class="pagewidth clearfix grid4" <?php echo !$this->appSettings->search_view_mode?'style="display: none"':'' ?>>
		...
		<article id="post-63" class="post-63 post type-post status-publish format-standard hentry category-food post clearfix ">
			<div class="post-inner">
				...
				<div class="post-content">
					...
					<span class="post-date" ><span itemprop="street-address"><?php echo $company->street_number.' '.$company->address?></span>, <span itemprop="locality"><?php echo $company->city?></span>, <span itemprop="country-name"><?php echo $company->countryName?></span></span>
