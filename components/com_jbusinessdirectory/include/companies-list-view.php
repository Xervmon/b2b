				...
				<div class="business-details row-fluid">
					...
					<div class="result-content span10">
						<div class="company-info" itemtype="http://data-vocabulary.org/Organization">
							...
							<?php if($company->latitude && $company->longitude && $showData && (isset($company->packageFeatures) && in_array(GOOGLE_MAP,$company->packageFeatures) || !$enablePackages)){?>
								<!-- a rel="nofollow" onclick="" class="map-link no-tracks" href="<?php echo JBusinessUtil::getCompanyLink($company)?>?tabId=2"><span>Â»</span> Map</a-->
							<?php }?>
						...
						<ul class="company-features">
							<?php if($showData && isset($company->website) && $company->website!='' && (isset($company->packageFeatures) && in_array(WEBSITE_ADDRESS,$company->packageFeatures) || !$enablePackages)){?>				
