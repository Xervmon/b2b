				...
				<div class="business-details row-fluid">
					...
					<div class="result-content span9">
						...
						<div class="company-info" itemscope itemtype="http://data-vocabulary.org/Organization">
							...
							<?php if (isset($company->contact_name)){ ?>
							...
							<?php if($company->latitude && $company->longitude && $showData){?>
								<!-- a rel="nofollow" onclick="" class="map-link no-tracks" href="<?php echo JBusinessUtil::getCompanyLink($company)?><?php echo $enableSEO?"?":"&"?>tabId=2"><span>Â»</span> Map</a-->
							<?php }?>
