					...
					<div class="company-info-details">
						...
						<?php if(isset( $this->company->phone) &&  $this->company->phone!='' && $showData){ ?>
								<span class="phone" itemprop="tel">
									T <a href="tel:<?php  echo $this->company->phone; ?>"><?php  echo $this->company->phone; ?></a>
								</span>
								<br/>
						<?php } ?>
				...
				<a href="javascript:showMap()" title="Show Map">
					<?php 
						if((isset($this->package->features) && in_array(GOOGLE_MAP,$this->package->features) || !$appSettings->enable_packages ) 
							...
							echo '<img src="http://maps.googleapis.com/maps/api/staticmap?center='.$this->company->latitude.','.$this->company->longitude.'&zoom=13&size=200x106&markers=color:blue|'.$this->company->latitude.','.$this->company->longitude.'&sensor=false">';
						}
					?>
				</a> 	
