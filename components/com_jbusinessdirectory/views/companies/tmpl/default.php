				...
				<div class="company-info-details">
					...
					<ul class="features-links">
							...
							<?php if(($showData && isset($this->package->features) && in_array(WEBSITE_ADDRESS,$this->package->features) || !$appSettings->enable_packages) && !empty($company->website)){ ?>
									<a title="<?php echo $this->company->name?> Website" target="_blank" rel="nofollow"  href="<?php echo JRoute::_('index.php?option=com_jbusinessdirectory&view=companies&task=companies.showCompanyWebsite&companyId='.$company->id) ?>">Â» <?php echo JText::_('LNG_WEBSITE') ?></a>
								<?php }?>
							</li>
					</ul>
