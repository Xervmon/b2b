...
JHtml::_('stylesheet', 'components/com_jbusinessdirectory/assets/css/prettyPhoto.css');
...
JHtml::_('script', 'components/com_jbusinessdirectory/assets/js/jquery.prettyPhoto.js');
JHtml::_('script', 'components/com_jbusinessdirectory/assets/js/jslidergallery.js');
