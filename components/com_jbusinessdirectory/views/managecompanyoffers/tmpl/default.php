...
<div class="button-row right">
	<button type="button" class="ui-dir-button ui-dir-button-orange" onclick="addOffer()">
			<span class="ui-button-text"><?php echo JText::_("LNG_ADD_NEW_OFFER")?></span>
	</button>
		...
		<TABLE class="dir-table">
			<thead>
				<tr>
					...
					<th width='10%' align=center><?php echo JText::_('LNG_PRICE'); ?>	</th>
					<th width='10%' align=center><?php echo JText::_('LNG_SPECIAL_PRICE'); ?>	</th>
					<th width='10%' align=center><?php echo JText::_('LNG_START_DATE'); ?></th>
					<th width='10%' align=center><?php echo JText::_('LNG_END_DATE'); ?></th>
					<th width='10%' align=center><?php echo JText::_('LNG_STATE'); ?></th>
					<th></th>
				</tr>
			</thead>
			<tbody>
