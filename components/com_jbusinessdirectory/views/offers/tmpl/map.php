 <script>
      ...
      var companies = [
        ...
        foreach($this->offers as $offer){
        	...
        	'<h1 id="firstHeading" class="firstHeading">'.$db->escape($offer->subject).'</h1>'.
        	'<p>'.
        	...
        	'</p>'.
        	'<p><a href="'.$db->escape(JBusinessUtil::getOfferLink($offer->id, $offer->alias)).'">'.JText::_("LNG_MORE_INFO",true).'</a></p>'.
        	'</div>';
