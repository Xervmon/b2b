...
<!-- layout -->
<div id="layout" class="pagewidth clearfix grid4 grid-view-1">
		...
		<article id="post-<?php echo  $offer->id ?>" class="post post type-post status-publish format-standard hentry category-food post clearfix ">
			<div class="post-inner">
				...
				<div class="post-content">
					...
					<span class="post-date" ><span itemprop="address"><?php echo JBusinessUtil::getLocationTextOffer($offer)?></span></span>
