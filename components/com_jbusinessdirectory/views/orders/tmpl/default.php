...
<div class="left"> <a href="<?php echo JRoute::_('index.php?option=com_jbusinessdirectory&view=useroptions') ?>"><?php echo JText::_("LNG_BACK_TO_CONTROL_PANEL") ?> </a></div>
<br/>
	...
	<?php foreach($this->orders as $order){?>
		<div class="order-container">
			<div class="order-details">
				...
				<?php echo $order->state == 0 ? JText::_("LNG_AWAITING_PAYMENT"):JText::_("LNG_PAID")  ?> | <?php echo $order->amount ?> <?php echo $this->appSettings->currency_name?> | <?php echo $order->created ?>
			</div>
			...
			<div class="order-options">
				...
				<button type="button" class="ui-dir-button ui-dir-button-green" onclick="showInvoice(<?php echo $order->id; ?>)">
						<span class="ui-button-text"><?php echo JText::_("LNG_INVOICE")?></span>
				</button>
			</div>
			<div class="clear"></div>
		</div>
...
// starting the script on page load
	...
	function showInvoice(invoice){
		...
		jQuery.blockUI({ message: jQuery('#invoice'), css: {width: '800px', top: '5%', position: 'absolute'} });
