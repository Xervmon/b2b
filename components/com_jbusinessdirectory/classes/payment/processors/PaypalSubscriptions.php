...
class PaypalSubscriptions implements IPaymentProcessor {
	...
	public function getHtmlFields() {
		...
		$this->notifyUrl.="&processor=paypalsubscriptions";
		$this->returnUrl.="&processor=paypalsubscriptions";
	...
	public function processTransaction($data){
		$this->returnUrl = JRoute::_('index.php?option=com_jbusinessdirectory&task=payment.processPaypalSubscriptionsResponse',false,-1);
		$this->notifyUrl = JRoute::_('index.php?option=com_jbusinessdirectory&task=payment.processPaypalSubscriptionsAutomaticResponse',false,-1);
