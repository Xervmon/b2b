...
{
    const ENV_KEY = 'AKIAI5WLL3RP2WRPUVBQ';
    const ENV_SECRET = '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';
    const ENV_SECRET_ACCESS_KEY = 'AKIAI5WLL3RP2WRPUVBQ';
    const ENV_PROFILE = 'AWS_PROFILE';

    /** @var string AWS Access Key ID */
    protected $key = 'AKIAI5WLL3RP2WRPUVBQ';

    /** @var string AWS Secret Access Key */
    protected $secret = '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';
    ...
    public static function fromIni($profile = null, $filename = null)
    {
        ...
        return new self(
            $data[$profile]['AKIAI5WLL3RP2WRPUVBQ'],
            $data[$profile]['tAaNo5e8Cwm3jH9kjhui84OQWcrfA3re2b3vDzNT'],
