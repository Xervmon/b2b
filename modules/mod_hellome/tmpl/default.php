...
<div id="cModule-HelloMe" class="cMods cMods-HelloMe<?php echo $params->get('moduleclass_sfx'); ?>">
    ...
    if ($my->isOnline() && $my->id != 0) {
        ...
        <div class="cHello-Header">
            <?php if ($show_avatar) { ?>
                <img class="cHello-Avatar" src="<?php echo $myAvatar; ?>" alt="<?php echo str_replace('&amp;', '&', CStringHelper::escape($myName)); ?>" />
            <?php } ?>
            <h3><a href="<?php echo CRoute::_('index.php?option=com_community&view=profile') ?>"><?php echo str_replace('&amp;', '&', CStringHelper::escape($myName)); ?></a></h3>
            <?php if ( $params->get('enable_alert',1) == 1 ) { ?>
                <div class="cMod-Notify">
                    <a class="joms-module-global-notif" href="javascript:joms.notifications.showWindow();"  title="<?php echo JText::_('COM_COMMUNITY_NOTIFICATIONS_GLOBAL'); ?>">
                        ...
                        <span class="notifcount"><?php echo ($newEventInviteCount) ? $newEventInviteCount : '' ;?></span>
                    </a>
                    ...
                    <a class="joms-module-new-message-notif" href="<?php echo CRoute::_('index.php?option=com_community&view=inbox'); ?>"   onclick="joms.notifications.showInbox();return false;" title="<?php echo JText::_('COM_COMMUNITY_NOTIFICATIONS_INBOX'); ?>">
                        ...
                        <span class="notifcount"><?php echo ($newMessageCount) ? $newMessageCount : '' ;?></span>
                    </a>
                </div>
            <?php } ?>
        ...
        <?php if ( $params->get('enable_menu',1) == 1 ) { ?>
            <div class="cHello-Menu">
                ...
                <div>
                    ...
                    &nbsp;
                    <a href="javascript:" onclick="document.getElementById('hellomelogout').submit();"><?php echo JText::_('MOD_HELLOME_MY_LOGOUT'); ?></a>
                </div>
            </div><!--.cHello-Menu-->
        <?php } ?>
