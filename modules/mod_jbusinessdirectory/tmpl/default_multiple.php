						...
						<span class="label">
							<select name="countrySearch" id="countrySearch">
								...
								<?php foreach($countries as $country){?>
									<option value="<?php echo $country->country_id?>" <?php $session = JFactory::getSession(); echo $session->get('countrySearch')==$country->country_id?" selected ":"" ?> ><?php echo $country->country_name?></option>
								<?php }?>
